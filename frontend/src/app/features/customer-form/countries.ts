...
// Regional indicator emoji flags are derived from the ISO 3166-1 alpha-2 code
// (each letter maps to a Unicode "regional indicator symbol"), so flags don't
// need to be hardcoded or stored as image assets.
